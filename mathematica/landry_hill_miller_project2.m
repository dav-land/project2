...
(**)
(*mountainPlot3D = Plot3D[m[x,y],{x,0,5},{y,0,5}, AxesLabel->{"x in 1000ft","y in 1000ft","Elevation gain from 7000ft in 1000ft"}, PlotLabel->"Lagrange Mountain Range", ColorFunction->"GreenBrownTerrain"]*)
(**)
